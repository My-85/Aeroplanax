...
config = {
    ...
    "SEED": 42,
    "NOISE_SEED": 42,
    "GROUP": "lczh_2v2_origin_lstm_add_actor_layer_norm",
    "FOR_LOOP_EPOCHS": 30,
    "WANDB": True,
    "TRAIN": True,
    "WANDB_API_KEY" : "4c0cc04699296bed768adea4824fbaecea35dc59",
    "OUTPUTDIR": "results/" + "combat_hierarchy_2V2" + str_date_time,
    "LOGDIR": "results/" + "combat_hierarchy_2V2" + str_date_time + "/logs",
    "SAVEDIR": "results/" + "combat_hierarchy_2V2" + str_date_time + "/checkpoints",
...
if config["WANDB"]:
    ...
    wandb.init(
        project="AeroPlanax",
        config=config,
        name='lczh_2v2_origin_lstm_add_actor_layer_norm',
        group=Env.__name__,
