...
class ActorCriticLSTM(nn.Module):
    ...
    def __call__(self, hidden, x):
        ...
        nn_fc2 = nn.LayerNorm()(nn_fc2) # 加一个归一化层
...
def test(config, rng):
    ...
    if "LOADDIR" in config:
        ...
        print("restored epoch =", int(checkpoint["epoch"])) # 校验加载确实成功（防止“没加载到又在用随机参数”）
...
config = {
    ...
    "ACTIVATION": "relu",
    "ANNEAL_LR": False,
    # "LOADDIR": "/home/dqy/NeuralPlanex/Planax_lczh/Planax_lczh/2v2_lczh/AeroPlanax_multi_combat_2v2/envs/models/baseline/lstm_Yaw_Pitch_V/baseline_stable_2"
    # "LOADDIR": "/home/dqy/NeuralPlanex/Planax_lczh/Planax_lczh/results/heading_pitch_V_discrete_lstm_2025-08-16-10-12/checkpoints/checkpoint_epoch_500" # 不带中间奖励并且unreach_heading_pitch_V.py里面mask1只由时间决定（宽松版）训练出来的（可行）
    # "LOADDIR": "/home/dqy/NeuralPlanex/Planax_lczh/Planax_lczh/results/heading_pitch_V_discrete_lstm_2025-08-17-12-11/checkpoints/checkpoint_epoch_400" # 带中间奖励并且unreach_heading_pitch_V.py里面mask1只由时间决定（宽松版）训练出来的（飞机机动乱）
    "LOADDIR": "/home/dqy/NeuralPlanex/Planax_lczh/Planax_lczh/Planax/envs/models/LSTM_baseline_new(add_layer_norm)/heading_pitch_V_discrete_lstm_2025-08-28-14-51/checkpoints/checkpoint_epoch_600"
}
