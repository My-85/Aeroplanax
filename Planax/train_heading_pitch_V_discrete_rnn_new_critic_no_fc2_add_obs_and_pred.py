...
from envs.aeroplanax_heading_pitch_V_add_obs_and_pred import AeroPlanaxHeading_Pitch_V_Env, Heading_Pitch_V_TaskParams
...
config = {
    "GROUP": "baseline(new_rnn_6e8_critic_no_fc2_seed42_add_obs_and_pred)",
    "SEED": 42,
    "FOR_LOOP_EPOCHS": 1,
    "LR": 3e-4,
    "NUM_ENVS": 1000,
    ...
    "OUTPUTDIR": "results/" + "heading_pitch_V_discrete_rnn_add_obs_and_pred" + "_" + str_date_time,
    "LOGDIR": "results/" + "heading_pitch_V_discrete_rnn_add_obs_and_pred" + "_" + str_date_time + "/logs",
    "SAVEDIR": "results/" + "heading_pitch_V_discrete_rnn_add_obs_and_pred" + "_" + str_date_time + "/checkpoints",
