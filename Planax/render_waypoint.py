...
def main():
    ...
    with open(env.filename, mode="a", encoding="utf-8") as f:
        f.write(f"{9000},T={wlon}|{wlat}|{walt}|0|0|0,Name=WP_0,Color=Yellow,Type=ReferencePoint\n")
    ...
    for _ in range(NUM_STEPS):
        ...
        if reached_cnt_now > prev_reached:
            ...
            wlat, wlon, walt = enu_to_geodetic(wp_e, wp_n, wp_alt, 0, 0, 0)
            with open(env.filename, mode="a", encoding="utf-8") as f:
                f.write(f"{9000 + reached_cnt_now},T={wlon}|{wlat}|{walt}|0|0|0,Name=WP_{reached_cnt_now},Color=Yellow,Type=ReferencePoint\n")
