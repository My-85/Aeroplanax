...
from envs.aeroplanax_quat_baseline_iter import AeroPlanaxHeading_Pitch_V_Env, Heading_Pitch_V_TaskParams
...
config = {
    ...
    "NUM_ACTORS": 1,
    "NUM_STEPS": 1000,
    "TOTAL_TIMESTEPS": float(os.environ.get("DRYRUN_TIMESTEPS", 1e9)),
    "FC_DIM_SIZE": 128,
    "GRU_HIDDEN_DIM": 128,
    "UPDATE_EPOCHS": 16,
    "NUM_MINIBATCHES": 5,
    ...
    # "LOADDIR": "/home/dqy/NeuralPlanex/Planax_lczh/Planax_lczh/results/heading_pitch_V_discrete_rnn_2025-12-11-00-38/checkpoints/checkpoint_epoch_1700" # roll、pitch、yaw都是随机初始化，并且目标也是的baseline(trained twice)
    # "LOADDIR": "/home/dqy/NeuralPlanex/Planax_lczh/Planax_lczh/results/heading_pitch_V_discrete_rnn_2025-12-11-20-24/checkpoints/checkpoint_epoch_2700" # roll、pitch、yaw都是随机初始化，并且目标也是的baseline(trained third)
...
latest_checkpoint_path = os.environ.get("LOADDIR", None) or config.get("LOADDIR", None)
...
for i in range(config["FOR_LOOP_EPOCHS"]):
    ...
    print(f"CHECKPOINT {latest_checkpoint_path} epoch {out['epoch']}, iteration {i+1}/{config['FOR_LOOP_EPOCHS']}")
    ################
