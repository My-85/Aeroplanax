        ...
        def _update_step(update_runner_state, _):
            ...
            if cfg.get("DEBUG"):
                def callback(m):
                    ...
                    env_steps = u * int(cfg["NUM_ENVS"]) * int(cfg["NUM_STEPS"])
                    # 损失/比率
...
config = {
    "GROUP": "baseline_quat_increase_pitch_to_89_random_pitch",
    "SEED": 42,
    "FOR_LOOP_EPOCHS": 1,
    "LR": 3e-4,
    "NUM_ENVS": 1000,
    ...
    # "LOADDIR": "/home/dqy/NeuralPlanex/Planax_lczh/Planax_lczh/results/heading_pitch_V_discrete_rnn_2025-11-19-16-12/checkpoints/checkpoint_epoch_600"
    # "LOADDIR": "/home/dqy/NeuralPlanex/Planax_lczh/Planax_lczh/results/heading_pitch_V_discrete_rnn_2025-12-06-01-30/checkpoints/checkpoint_epoch_800"
    #  "LOADDIR": "/home/dqy/aeroplanax/new/20251215最新代码库/results/baseline_quat_increase_pitch_to_89_random_pitch_decrease_min_vt_to_50_2026-02-08-01-26/checkpoints/checkpoint_epoch_2000" # -89°~89°并随机初始化pitch的baseline
    #  "LOADDIR": "/home/dqy/aeroplanax/new/20251215最新代码库/results/heading_pitch_V_discrete_rnn_2026-02-08-17-26/checkpoints/checkpoint_epoch_2600" # trained twice baseline
    # "LOADDIR": "/home/dqy/aeroplanax/new/20251215最新代码库/results/baseline_quat_increase_pitch_to_89_random_pitch_decrease_min_vt_to_50_trained_third_2026-02-08-20-39/checkpoints/checkpoint_epoch_3200" # trained third baseline
}

seed = config['SEED']
# wandb.tensorboard.patch(root_logdir=config['LOGDIR']) # 注释掉
wandb.init(
    project="AeroPlanax",
    config=config,
    name=config['GROUP'],
